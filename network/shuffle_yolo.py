...
import network.shufflenet as shufflenet


class Shuffle_YOLO(nn.Module):
    def __init__(self, config, is_training=True):
        super(Shuffle_YOLO, self).__init__()
        self.config = config
        self.training = is_training
        #  backbone
        self.backbone = shufflenet.shufflenetv2(config.backbone_pretrained)
