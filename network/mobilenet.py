...
def _make_divisible(v, divisor, min_value=None):
    ...
    It can be seen here:
    https://github.com/tensorflow/models/blob/master/research/slim/nets/mobilenet/mobilenetv2.py
    :param v:
    :param divisor:
    :param min_value:
    :return:
...
class MobileNet2(nn.Module):
    ...
    def __init__(self, scale=1.0, input_size=224, t=6, in_channels=3, num_classes=1000, activation=nn.ReLU6):
        ...
        self.num_of_channels = [32, 16, 32, 64, 64, 128, 128, 256]
        assert (input_size % 32 == 0)
        self.layers_out_filters = [384, 768, 1024]

        self.c = [_make_divisible(ch * self.scale, 8) for ch in self.num_of_channels]
        self.n = [1, 1, 3, 3, 4, 3, 3, 1]
        ...
        self.last_conv_out_ch = 1024 if self.scale <= 1 else _make_divisible(1024 * self.scale, 8)
